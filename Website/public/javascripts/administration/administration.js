...
///#source 1 1 /public/javascripts/administration/app.js
var Administration;
(function (Administration) {
    ...
    angular.module("app", [
        ...
        function ($routeProvider, $locationProvider) {
            $routeProvider.when("/administration", { controller: "main", templateUrl: "/public/javascripts/administration/templates/index.html" }).when("/administration/allusers", { controller: "main", templateUrl: "/public/javascripts/administration/templates/allusers.html" }).when("/administration/createuser", { controller: "main", templateUrl: "/public/javascripts/administration/templates/createuser.html" }).when("/administration/user/:username", { controller: "main", templateUrl: "/public/javascripts/administration/templates/user.html" }).when("/administration/changepassword/:username", { controller: "main", templateUrl: "/public/javascripts/administration/templates/changepassword.html" }).when("/administration/deleteuser/:username", { controller: "main", templateUrl: "/public/javascripts/administration/templates/deleteuser.html" }).when("/administration/allroles", { controller: "main", templateUrl: "/public/javascripts/administration/templates/allroles.html" }).when("/administration/role/:name", { controller: "main", templateUrl: "/public/javascripts/administration/templates/role.html" }).otherwise({ redirectTo: "/administration" });
...
///#source 1 1 /public/javascripts/administration/controllers.js
var Administration;
(function (Administration) {
    "use strict";
