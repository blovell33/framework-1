...
///#source 1 1 /public/javascripts/account/app.js
var Account;
(function (Account) {
    "use strict";
...
///#source 1 1 /public/javascripts/account/controllers.js
var Account;
(function (Account) {
    "use strict";
    ...
    angular.module("app").controller("main", [
        ...
        function ($scope, $provider, $location) {
            ...
            $scope.signIn = function () {
                $scope.post("/api/account/signin", $scope.model, function () {
